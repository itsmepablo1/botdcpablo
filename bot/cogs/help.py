...
class Help(commands.Cog):
    ...
    async def help(self, interaction: discord.Interaction):
        ...
        music.add_field(name="🌐 `/play <lagu>`",         value="Putar dari YouTube (URL/kata kunci).",    inline=False)
        ...
        music.add_field(name="🌐 `/nowplaying`",          value="Info lagu yang sedang diputar.",         inline=True)
        music.add_field(name="🌐 `/volume <0-200>`",      value="Atur volume (default 100).",             inline=True)
        music.add_field(name="🌐 `/shuffle`",             value="Acak urutan antrian lagu.",              inline=True)
        music.add_field(name="🌐 `/repeat <on|off>`",     value="Ulangi lagu yang sedang diputar.",       inline=True)
        music.add_field(name="🌐 `/deleteallqueue`",      value="Hapus semua antrian.",                   inline=True)
        music.add_field(name="⏱️ Auto Disconnect",           value="Bot otomatis keluar jika tidak ada lagu selama **5 menit**.", inline=False)
